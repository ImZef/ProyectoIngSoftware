...
from Consola.Inventario_menu import MenuInventario
from Consola.Venta_menu import MenuVentas
from Consola.Registro_menu import MenuRegistros
from Consola.Historialclinico_menu import MenuHistorialClinico

usuarios ={'admin': 'admin123', 'bod': 'bodeguero123', 'vet': 'veterinario123', 'auxventas': 'auxventas123'}
class MenuPrincipal:
    def __init__(self, inventario, rol_usuario=None):
        """Inicializa el menú principal.

        Parámetros
        ----------
        inventario : Inventario
            Instancia del inventario compartida con otros menús.
        rol_usuario : dict | None
            Información del rol seleccionado desde la GUI. Si se ejecuta
            directamente desde la consola se mantiene en ``None`` y se usa
            la lógica local de usuarios/contraseñas.
        """
